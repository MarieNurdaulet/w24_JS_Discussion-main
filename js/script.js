...
// Question 1
document.querySelector("#host-name").innerHTML = "Marie";
document.querySelector("#collaborator-name").innerHTML = "Marie";
document.querySelector("#collaborator-2-name").innerHTML = "Serena";
